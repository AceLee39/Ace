 ...
 */
public class NianDChart extends ApplicationFrame {
     ...
     */
    public NianDChart(final String title, final Object[][] dataArray) {
        super(title);
    ...
    private XYDataset createDataset() {
        ...
        System.out.println("dataArray.length : " + length);
        for (int i = 0; dataArray[i] != null && i < length - 1; i++) {
            final String nianD = (String) dataArray[i][0];
            final int year = CommenUtils.parseNian(nianD);
            cudd.add(new Year(year), NumberUtils.toDouble((String) dataArray[i][1]));
            resi.add(new Year(year), NumberUtils.toDouble((String) dataArray[i][2]));
        }
