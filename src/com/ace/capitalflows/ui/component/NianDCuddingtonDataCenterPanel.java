...
public class NianDCuddingtonDataCenterPanel extends AbstractCenterPanel {
    ...
    protected DataModel initDataModel() {
        ...
        nianDDataModule.setResidual(Boolean.FALSE);
    ...
    protected String initCenterPanelName() {
        return Constant.CENTER_YEAR_CUDDINGTON_DATA;
    }
}
